        ...
        <Container maxWidth="lg">
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} md={4}>
              ...
              <FooterLink onClick={() => {
                const servicesButton = document.querySelector('[data-menu="services"]');
                if (servicesButton) {
                  servicesButton.click();
                  window.scrollTo(0, 0);
                }
              }} sx={{ cursor: 'pointer' }}>Services</FooterLink>
              <FooterLink onClick={() => { navigate('/careers'); window.scrollTo(0, 0); }} sx={{ cursor: 'pointer' }}>Careers</FooterLink>
              <FooterLink onClick={() => {
                const knowledgeButton = document.querySelector('[data-menu="knowledge"]');
                if (knowledgeButton) {
                  knowledgeButton.click();
                  window.scrollTo(0, 0);
                }
              }} sx={{ cursor: 'pointer' }}>Knowledge & Events</FooterLink>
